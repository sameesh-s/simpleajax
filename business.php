...
if(!isset($_SESSION['latest']))
	...
	{
	if((($_SESSION['latest']!=$latest[0]) && ($latest[2]==2)) || $_SESSION['countb'] > 3 )
        	{
		$_SESSION['countb']=1;
		$_SESSION['business']=$latest[0];
		}	
...
echo $row[1]."<br><a href='view.php?news=".$row[0]."'><img src='images/".$row[4]."' alt='imge loading failed' height='200' width='200'><br></a>| Business";
?>
